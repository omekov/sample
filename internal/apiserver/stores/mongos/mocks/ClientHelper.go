...
import (
	databases "github.com/omekov/sample/internal/apiserver/stores/mongos"
...
func (_m *ClientHelper) Database(_a0 string) databases.Database {
	ret := _m.Called(_a0)

	var r0 databases.Database
	if rf, ok := ret.Get(0).(func(string) databases.Database); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(databases.Database)
		}
	}
