...
type Customer struct {
	ID                primitive.ObjectID `bson:"_id" json:"-" swaggerignore:"true"`
	Username          string             `bson:"username" json:"username,omitempty" example:"example@gmail.com"`
	Password          string             `bson:"password" json:"password,omitempty" example:"-"`
	FirstName         string             `bson:"firstname" json:"firstname,omitempty" example:"Adam"`
	RepeatPassword    string             `bson:"repeatPassword" json:"repeatPassword,omitempty" example:"-"`
	EncryptedPassword string             `bson:"encryptedPassword" json:"-" swaggerignore:"true"`
	Blocked           bool               `bson:"blocked" json:"-" swaggerignore:"true"`
	Actived           bool               `bson:"actived" json:"-" swaggerignore:"true"`
	RegistrationDate  time.Time          `bson:"registrationDate" json:"-" swaggerignore:"true"`
	ReleaseDate       time.Time          `bson:"releaseDate" json:"-" swaggerignore:"true"`
}
